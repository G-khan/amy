...
const Home = () => {
  ...
  const artworks = [
    ...
    {
      image: "https://images.unsplash.com/photo-1531280558162-f4839ae86457?q=80&w=400&h=300&fit=crop&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=400&h=300&fit=crop",
      title: "Artistic Title 2",
      description: "An exploration of form and movement through textured elements."
    },
    {
      image: "https://plus.unsplash.com/premium_photo-1664438942214-fee803f245b5?q=80&w=400&h=300&fit=crop&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=400&h=300&fit=crop",
      title: "Artistic Title 3",
      description: "A contemporary take on traditional artistic methods."
    },
    {
      image: "https://images.unsplash.com/photo-1580039648058-ce393a58a10b?q=80&w=400&h=300&fit=crop&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&w=400&h=300&fit=crop",
          ...
          <div className="slider-container">
            {artworks.map((artwork, index) => (
              <div 
                ...
                style={{
                  transform: `translateX(${(index - currentSlide) * 50}%)`,
