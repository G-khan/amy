...
const Home = () => {
  ...
  return (
    <div className="container" style={{marginBottom: '0px', marginTop: '0px'}}>
      <div className="tokyo_tm_home" style={{marginBottom: '0px', marginTop: '0px'}}>
        ...
        <div className="card-slider" style={{marginBottom: '0px'}}>
          <button 
