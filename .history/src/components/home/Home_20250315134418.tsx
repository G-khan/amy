    ...
    <div className="container">
      <div className="tokyo_tm_home">
        <div className="home_content" style={{marginBottom: '0px', marginTop: '0px'}}>
          ...
          <div className="details" style={{marginBottom: '0px', marginTop: '0px'}}>
        ...
        <h4 className="section-title" style={{marginBottom: '0px', marginTop: '0px'}}>Featured Artworks</h4>
        <div className="card-slider" style={{marginBottom: '0px', marginTop: '0px'}}>
          <button 
          ...
          <div className="card-slider-container" ref={sliderRef} style={{marginBottom: '0px', marginTop: '0px'}}>
            {artworks.map((artwork, index) => (
              <div key={index} className="card" style={{marginBottom: '0px', marginTop: '0px'}}>
