      ...
      <div className="tokyo_tm_home">
        ...
        <div className="artwork-slider">
          <div className="slider-container">
            ...
            <button className="slider-button prev" onClick={prevSlide} disabled={isAnimating}>
              <FontAwesomeIcon icon={faChevronLeft} />
            </button>
            <button className="slider-button next" onClick={nextSlide} disabled={isAnimating}>
          ...
          <div className="progress-bar">
            <div 
              className="progress" 
              style={{ width: `${((currentSlide + 1) / artworks.length) * 100}%` }}
            />
          </div>
        </div>
      </div>
