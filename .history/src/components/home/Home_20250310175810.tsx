...
const Home = () => {
  ...
  const artworks = [
    {
      image: "https://images.unsplash.com/photo-1515405295579-ba7b45403062?q=80&fm=jpg&w=400&h=300&fit=crop",
      title: "Artistic Title 1",
      description: "A beautiful piece showcasing the interplay of texture and color."
    },
    {
      image: "https://images.unsplash.com/photo-1531280558162-f4839ae86457?q=80&fit=crop",
