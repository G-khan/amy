...
const Home = () => {
  ...
  return (
    <div className="container">
      <div className="tokyo_tm_home" style={{marginBottom: '0px', paddingBottom: '0px'}}>
        <div className="home_content" style={{marginBottom: '0px', marginTop: '0px'}}>
          ...
          <div className="details" style={{marginBottom: '0px', paddingBottom: '0px'}}>
        ...
        <div className="card-slider" style={{marginBottom: '0px', paddingBottom: '0px'}}>
          <button 
