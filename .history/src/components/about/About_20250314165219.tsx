  ...
  return (
    <div className="tokyo_tm_about">
      <div className="container">
        ...
        <div className="author_info" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', marginBottom: '2rem' }}>
        ...
        <div className="tokyo_tm_button" style={{ textAlign: 'center', marginTop: '40px' }}>
