      ...
      <div className="container">
        ...
        <div className="tokyo_tm_about">
          ...
          <div className="about_title">
            ...
            <span>Contemporary Artist & Texture Specialist</span>
          </div>
            ...
            <div className="left">
              <div className="tokyo_tm_info">
                <ul>
                  ...
                  <li><span>Email:</span><a href="mailto:contact@amyartstudio.com">contact@amyartstudio.com</a></li>
                  <li><span>Phone:</span><a href="tel:+905555555555">+90 555 555 5555</a></li>
                </ul>
              </div>
            </div>
            <div className="right">
              <div className="tokyo_tm_info">
                <ul>
                  ...
                  <li><span>Specialty:</span><span>Textured Painting</span></li>
                </ul>
              </div>
            </div>
          </div>
          
          <div className="tokyo_tm_button" style={{ textAlign: 'left' }}>
