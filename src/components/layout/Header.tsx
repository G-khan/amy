      ...
      <div className={`tokyo_tm_mobile_menu ${isMenuOpen ? 'opened' : ''}`}>
        <div className="menu_list">
          <ul className="transition_link">
            <li className="active"><a href="#home" onClick={() => setIsMenuOpen(false)}>{navLabels.home}</a></li>
            <li><a href="#about" onClick={() => setIsMenuOpen(false)}>{navLabels.about}</a></li>
            <li><a href="#service" onClick={() => setIsMenuOpen(false)}>{navLabels.service}</a></li>
            <li><a href="#portfolio" onClick={() => setIsMenuOpen(false)}>{navLabels.portfolio}</a></li>
            <li><a href="#contact" onClick={() => setIsMenuOpen(false)}>{navLabels.contact}</a></li>
          </ul>
